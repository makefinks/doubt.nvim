...
describe("review run export", function()
	it("creates an agent-attribution checkpoint for trusted handoffs", function()
		...
		t.assert_match(exported, "The summary must include concrete reasoning", "protocol should require concrete reasoning for every outcome")
		t.assert_match(exported, "concrete reasoning: what was investigated", "protocol should specify what investigation details to include")
