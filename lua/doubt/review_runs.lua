...
function M.protocol_text(run)
	...
	return table.concat({
		...
		"- The summary must include concrete reasoning: what was investigated, what was found, why the decision was made, and what (if anything) was changed. This is displayed to the reviewer as the agent's response.",
		...
		'  - answered: the agent responded without code changes. Summary must explain the analysis and conclusion.',
